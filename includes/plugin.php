...
class WP_Typetalk_Plugin {
	...
	public function run( $path ) {
		...
		// Instances.
		$this->post_type       = new WP_Typetalk_Post_Type( $this );
		$this->notifier        = new WP_Typetalk_Notifier( $this );
		$this->post_meta_box   = new WP_Typetalk_Post_Meta_Box( $this );
		$this->submit_meta_box = new WP_Typetalk_Submit_Meta_Box( $this );
		$this->event_manager   = new WP_Typetalk_Event_Manager( $this );
	}
